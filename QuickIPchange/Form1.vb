...
Public Class Form1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ChangeIPAddress(ComboBox1.SelectedItem, "static 192.168.1.66 255.255.255.0 192.168.1.1")
    End Sub

    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ChangeIPAddress(ComboBox1.SelectedItem, "static 192.168.100.66 255.255.255.0 192.168.100.1")
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ChangeIPAddress(ComboBox1.SelectedItem, "static 192.168.0.66 255.255.255.0 192.168.0.1")
    End Sub
